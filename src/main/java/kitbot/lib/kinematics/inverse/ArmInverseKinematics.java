package kitbot.lib.kinematics.inverse;
...
public class ArmInverseKinematics {
    ...
    public ArmInverseKinematics(double[] segmentLengths, Rotation2d[] minAngles, Rotation2d[] maxAngles,
    ...
    public ArmInverseKinematics(double[] segmentLengths, Translation3d targetLocation) {
        this.segmentLengths = segmentLengths;
        this.targetLocation = targetLocation;
